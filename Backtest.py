...
class DataPrep(object):
    def mp_poc(self):
        ...
        na0 = np.where((data.index.dayofweek == 6) & (data.index.hour == 17) & (data.index.minute == 1)) #for IB (17, 0)
        ...
        na1 = np.where(((data.index.dayofweek == 0)|(data.index.dayofweek == 1)|(data.index.dayofweek == 2)\
            |(data.index.dayofweek == 3)) & (data.index.hour == 15) & (data.index.minute == 30))#for IB (15, 31)
        nb1 = np.where(((data.index.dayofweek == 0)|(data.index.dayofweek == 1)|(data.index.dayofweek == 2)\
            |(data.index.dayofweek == 3)) & (data.index.hour == 15) & (data.index.minute == 15))#for IB (15, 14)
